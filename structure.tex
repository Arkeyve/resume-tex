...
\setmainfont{AlegreyaSans}[ % Make the default font EBGaramond
...
SmallCapsBoldFont=*-SCBold.ttf
]

\newfontfamily\cvtextfont[Path=fonts/]{AlegreyaSans-SC} % Create a new font family for the cursive font Freebooter Script, provided with the template in the fonts folder
...
\newcommand{\cstmbox}[1]{\tikz[baseline=(X.base)]\node [draw=gray!70,fill=white,thin,rectangle,inner sep=3pt, rounded corners=3pt] (X) {#1};}
...
\newcommand{\workposition}[5]{
    \textsc{\expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\Large{#3}}\\[4pt]}} % Job title
	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\large {\textbf{#4}}}\\} % Employer
    {\textsc{#1\expandafter\ifstrequal\expandafter{#2}{}{}{\hspace{6pt}\footnotesize{(#2)}}}\par} % Duration and conditional full time/part time text
    \medskip
...
\newcommand{\educationentry}[5]{
	...
	\expandafter\ifstrequal\expandafter{#5}{}{}{& {#5}\\[6pt]} % Institution
}
